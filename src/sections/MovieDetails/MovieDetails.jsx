...
const MovieDetails = (props) => {
  ...
  const castSliderNavigationId = 'movie-cast-slider-navigation-id'
  ...
  const reviewItems = [
    ...
    {
      name: 'Barbara Suesy',
      subtitle: 'From England',
      description: 'A beautiful movie with amazing acting, action and visuals. A must watch movie to be experienced in theatre.',
      ratingValue: 4.6,
    },
    {
      name: 'Ivan Ivanov',
      subtitle: 'From Russia',
      description: 'Sooooooo boring soo overrated',
      ratingValue: 2,
    },
    {
      name: 'Aniket Roy',
        ...
        <div className="movie-details__panel">
          <div className="movie-details__groups">
            ...
            <div className="movie-details__group">
              ...
              <Tags
                items={['English', 'Hindi', 'Tamil', 'Telegu', 'Russian']}
              />
            </div>
            <div className="movie-details__group movie-details__panel--large-gap-y">
              <h3 className="movie-details__title">
                <Icon name="star" />
                <span>Ratings</span>
              </h3>
